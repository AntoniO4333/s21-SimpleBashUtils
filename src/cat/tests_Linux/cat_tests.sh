...
declare -a tests=(
"VAR ./tests_Linux/test_case_cat.txt"
)

declare -a extra=(
"-s ./tests_Linux/test_1_cat.txt"
"-b -e -n -s -t -v ./tests_Linux/test_1_cat.txt"
"-t ./tests_Linux/test_3_cat.txt"
"-n ./tests_Linux/test_2_cat.txt"
"no_file.txt"
"-n -b ./tests_Linux/test_1_cat.txt"
"-s -n -e ./tests_Linux/test_4_cat.txt"
"./tests_Linux/test_1_cat.txt -n"
"-n ./tests_Linux/test_1_cat.txt"
"-n ./tests_Linux/test_1_cat.txt ./tests_Linux/test_2_cat.txt"
"-v ./tests_Linux/test_5_cat.txt"
)
